...
// Ajout d'alias pour matcher les noms Start.gg (minuscules)
const ALIASES = {
...
Object.entries(ALIASES).forEach(([alias, targetName]) => {
  const targetChar = CHARACTER_NAME_MAP[targetName];
  if (targetChar) {
    CHARACTER_NAME_MAP[alias] = targetChar;
  }
});
