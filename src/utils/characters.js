...
export const CHARACTERS = [
  ...
  { id: 2,  name: 'Donkey Kong',     slug: 'donkey_kong' },
  { id: 3,  name: 'Link',            slug: 'link' },
  { id: 4,  name: 'Samus',           slug: 'samus' },
  { id: 5,  name: 'Dark Samus',      slug: 'dark_samus' },
  ...
  { id: 12, name: 'Captain Falcon',  slug: 'captain_falcon' },
  { id: 13, name: 'Jigglypuff',      slug: 'jigglypuff' },
  { id: 14, name: 'Peach',           slug: 'peach' },
  { id: 15, name: 'Daisy',           slug: 'daisy' },
  { id: 16, name: 'Bowser',          slug: 'bowser' },
  { id: 17, name: 'Ice Climbers',    slug: 'ice_climbers' },
  { id: 18, name: 'Sheik',           slug: 'sheik' },
  { id: 19, name: 'Zelda',           slug: 'zelda' },
  { id: 20, name: 'Dr. Mario',       slug: 'dr_mario' },
  { id: 21, name: 'Pichu',           slug: 'pichu' },
  { id: 22, name: 'Falco',           slug: 'falco' },
  { id: 23, name: 'Marth',           slug: 'marth' },
  { id: 24, name: 'Lucina',          slug: 'lucina' },
  { id: 25, name: 'Young Link',      slug: 'young_link' },
  { id: 26, name: 'Ganondorf',       slug: 'ganondorf' },
  { id: 27, name: 'Mewtwo',          slug: 'mewtwo' },
  { id: 28, name: 'Roy',             slug: 'roy' },
  { id: 29, name: 'Chrom',           slug: 'chrom' },
  { id: 30, name: 'Mr. Game & Watch',slug: 'mr_game_watch' },
  { id: 31, name: 'Meta Knight',     slug: 'meta_knight' },
  { id: 32, name: 'Pit',             slug: 'pit' },
  { id: 33, name: 'Dark Pit',        slug: 'dark_pit' },
  { id: 34, name: 'Zero Suit Samus', slug: 'zero_suit_samus' },
  { id: 35, name: 'Wario',           slug: 'wario' },
  { id: 36, name: 'Snake',           slug: 'snake' },
  { id: 37, name: 'Ike',             slug: 'ike' },
  { id: 38, name: 'Pokémon Trainer', slug: 'pokemon_trainer' },
  { id: 39, name: 'Diddy Kong',      slug: 'diddy_kong' },
  { id: 40, name: 'Lucas',           slug: 'lucas' },
  { id: 41, name: 'Sonic',           slug: 'sonic' },
  { id: 42, name: 'King Dedede',     slug: 'king_dedede' },
  { id: 43, name: 'Olimar',          slug: 'olimar' },
  { id: 44, name: 'Lucario',         slug: 'lucario' },
  { id: 45, name: 'R.O.B.',          slug: 'rob' },
  { id: 46, name: 'Toon Link',       slug: 'toon_link' },
  { id: 47, name: 'Wolf',            slug: 'wolf' },
  { id: 48, name: 'Villager',        slug: 'villager' },
  { id: 49, name: 'Mega Man',        slug: 'mega_man' },
  { id: 50, name: 'Wii Fit Trainer', slug: 'wii_fit_trainer' },
  { id: 51, name: 'Rosalina',        slug: 'rosalina' },
  { id: 52, name: 'Little Mac',      slug: 'little_mac' },
  { id: 53, name: 'Greninja',        slug: 'greninja' },
  { id: 54, name: 'Mii Brawler',     slug: 'mii_brawler' },
  { id: 55, name: 'Mii Swordfighter',slug: 'mii_swordfighter' },
  { id: 56, name: 'Mii Gunner',      slug: 'mii_gunner' },
  { id: 57, name: 'Palutena',        slug: 'palutena' },
  { id: 58, name: 'Pac-Man',         slug: 'pac_man' },
  { id: 59, name: 'Robin',           slug: 'robin' },
  { id: 60, name: 'Shulk',           slug: 'shulk' },
  { id: 61, name: 'Bowser Jr.',      slug: 'bowser_jr' },
  { id: 62, name: 'Duck Hunt',       slug: 'duck_hunt' },
  ...
  { id: 72, name: 'King K. Rool',    slug: 'king_k_rool' },
  { id: 73, name: 'Isabelle',        slug: 'isabelle' },
  { id: 74, name: 'Incineroar',      slug: 'incineroar' },
  { id: 75, name: 'Piranha Plant',   slug: 'piranha_plant' },
  { id: 76, name: 'Joker',           slug: 'joker' },
  { id: 77, name: 'Hero',            slug: 'hero' },
  { id: 78, name: 'Banjo & Kazooie', slug: 'banjo_kazooie' },
  { id: 79, name: 'Terry',           slug: 'terry' },
  { id: 80, name: 'Byleth',          slug: 'byleth' },
  { id: 81, name: 'Min Min',         slug: 'min_min' },
  { id: 82, name: 'Steve',           slug: 'steve' },
  { id: 83, name: 'Sephiroth',       slug: 'sephiroth' },
  { id: 84, name: 'Pyra & Mythra',   slug: 'pyra_mythra' },
  { id: 85, name: 'Kazuya',          slug: 'kazuya' },
  { id: 86, name: 'Sora',            slug: 'sora' },
];
