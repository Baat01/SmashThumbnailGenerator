...
export default function App() {
  const { currentStep, apiKey } = useAppStore();

  // Si l'utilisateur a déjà une clé valide en localStorage → skip l'étape 0
  // (la validation a eu lieu lors du login, on peut naviguer librement)
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[var(--color-muted)] text-xs">Propulsé par Start.gg</p>
          </div>
        </div>
